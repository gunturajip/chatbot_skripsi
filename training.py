...
helpers = {
    ...
    "Tahun Jeda": "gap year",
    "WFH": "work from home",
    "Nego Gaji": "negosiasi gaji",
    "Tawaran Kerja": "job offering",
    "Penawaran Kerja": "job offering",
    "Portfolio": "portofolio",
    "Chat GPT": "chatgpt",
    "Kredibilitas": "personal branding",
    ...
    "Kesetaraan": "equity and inclusion",
    "Inklusi": "equity and inclusion",
    "Kesetaraan dan Inklusi": "equity and inclusion",
    "Kepemimpinan": "leadership",
    "kritis": "critical thinking",
    "berpikir kritis": "critical thinking",
    "pikiran kritis": "critical thinking",
    "Komunikasi": "communication",
    "Pengembangan Diri": "career and self-development",
    "UPN \"Veteran\" Jawa Timur": "upnvjt",
    "UPN Jawa Timur": "upnvjt",
    "UPNJATIM": "upnvjt",
    "UPN Veteran Jawa Timur": "upnvjt",
    ...
    "Freshgraduates": "fresh graduate",
    "Fresh Graduates": "fresh graduate",
    "Kupu-Kupu": "fresh graduate",
    "Kupu Kupu": "fresh graduate",
    "KupuKupu": "fresh graduate",
    "Preferensi": "passion",
    "Alumni": "fresh graduate",
    "Pemberdayaan": "sosialisasi",
    "Merintis Usaha": "wirausaha",
    "Wira Usaha": "wirausaha",
    "Memulai Usaha": "wirausaha",
    "Mendirikan Usaha": "wirausaha",
    "Membangun Usaha": "wirausaha",
    "Acara": "job fair",
    "Kemampuan": "kompetensi kerja",
    "Minat": "passion",
    "Bakat": "passion",
    "Lamaran Kerja": "lowongan kerja",
    "lulusan": "profil lulusan",
    "Menegosiasikan": "negosiasi gaji",
    "Gaji": "negosiasi gaji",
    "Loker": "lowongan kerja",
    "Keterampilan": "kompetensi kerja",
    "Channel": "networking",
    "Koneksi": "networking",
    "Mengembangkan": "pengembangan",
    "Melamar": "fresh graduate",
    "Mempersiapkan Diri": "fresh graduate",
    "Prospek": "lowongan kerja",
    "Lapangan Kerja": "lowongan kerja",
    "Peluang Kerja": "lowongan kerja",
